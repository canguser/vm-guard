...
[main/simple-run.ts:16](https://github.com/canguser/vm-guard/blob/acd8653/main/simple-run.ts#L16)
...
[main/simple-run.ts:21](https://github.com/canguser/vm-guard/blob/acd8653/main/simple-run.ts#L21)
