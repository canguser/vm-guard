...
- [emptyRequire](interface_guard_options.guardoptions.md#emptyrequire)
...
[main/simple-run.ts:13](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L13)
...
[main/simple-run.ts:12](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L12)
...
[main/simple-run.ts:11](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L11)
...
[main/simple-run.ts:17](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L17)
...
[main/simple-run.ts:15](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L15)
...
[main/interface/guard.options.ts:4](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L4)
...
[main/interface/guard.options.ts:7](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L7)

___

### emptyRequire

• `Optional` **emptyRequire**: `boolean`

#### Inherited from

SimpleRunOptions.emptyRequire

#### Defined in

[main/simple-run.ts:26](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L26)
...
[main/interface/guard.options.ts:9](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L9)
...
[main/simple-run.ts:14](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L14)
...
[main/simple-run.ts:16](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L16)
...
[main/simple-run.ts:19](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L19)
...
[main/simple-run.ts:20](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L20)
...
[main/interface/guard.options.ts:6](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L6)
...
[main/simple-run.ts:18](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L18)
...
[main/interface/guard.options.ts:8](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L8)
...
[main/simple-run.ts:21](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L21)
...
[main/simple-run.ts:10](https://github.com/canguser/vm-guard/blob/2e3cb31/main/simple-run.ts#L10)
...
[main/interface/guard.options.ts:5](https://github.com/canguser/vm-guard/blob/2e3cb31/main/interface/guard.options.ts#L5)
